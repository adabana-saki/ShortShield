...
async function createPlaceholderIcons(): Promise<void> {
  ...
  const minimalPng = Buffer.from([
    ...
    0x54, 0x08, 0xd7, 0x63, 0x78, 0xc1, 0xf0, 0x00,  // Blue color
    0x00, 0x00, 0x04, 0x00, 0x01, 0x5d, 0x52, 0x86,
    0xc5, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4e,  // IEND chunk
  ...
  for (const size of ICON_SIZES) {
    ...
    console.log(`Created placeholder: icon-${size}.png (replace before release)`);
  }

  console.log('\nPlaceholder icons created.');
  console.log('Install sharp (`pnpm add -D sharp`) and run again for proper icons.');
}
